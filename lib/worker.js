...
Worker.prototype._createThumbnails = function(localPath, job, callback) {
	...
	job.descriptions.forEach(function(description) {
		work.push(function(done) {
			...
			var remoteImagePath = getThumbnailKey(job.original, description.suffix, description.format),
...
LocalWorker.prototype.createThumbnails = Worker.prototype._createThumbnails;
